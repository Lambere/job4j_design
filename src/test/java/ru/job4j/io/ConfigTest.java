...
class ConfigTest {
    ...
    void whenPairWithWrongFormat() {
        String path = "./src/data/pair_wrong_format.properties";
        Config config = new Config(path);
        config.load();
        assertThatException();
    }
    ...
    void whenPairWithWrongFormat2() {
        String path = "./src/data/pair_wrong_format_2.properties";
        Config config = new Config(path);
        config.load();
    ...
    void whenPairWithWrongFormat3() {
        String path = "./src/data/pair_wrong_format_3.properties";
        Config config = new Config(path);
        config.load();
